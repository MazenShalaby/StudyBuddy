# Generated by Django 4.2.28 on 2026-02-14 08:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='Phone number must be 11 digits', regex='^\\d{11}$')])),
                ...
                ('profile_picture', models.ImageField(blank=True, default='profile_pictures/avatar.svg', upload_to='profile_pictures/')),
